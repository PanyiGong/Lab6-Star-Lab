...
let irBreath, orBreath; // Breathing radii modifiers
let breathingSpeed = 0.1; // Speed of the breathing effect
...
function draw() {
  ...
  //   that these functions, by default, are in radians [0,TWO_PI]
    irBreath = irBase + 10 * sin(t); // Inner radius fluctuates by ±10
  orBreath = orBase + 20 * cos(t); // Outer radius fluctuates by ±20
  t += breathingSpeed;
  drawStar(width / 2, height / 2, 7, irBreath, orBreath)
}
